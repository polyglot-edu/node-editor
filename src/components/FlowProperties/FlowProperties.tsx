...
const FlowProperties = (props: FlowPropertiesProps) => {
    const [selectedNodeId, selectedEdgeId] = useStore(state => [state.selectedNode, state.selectedEdge]);
    const [activeFlowInfo, updateFlowInfo] = useStore(state => [state.activeFlowInfo, state.updateFlowInfo]);
            ...
            <StackItem>
                <Card>
                    ...
                    <TextField
                        ...
                        onChange={textInputFlowUpdater(updater<PolyglotFlowInfo>()("description"))}
                    />
                </Card>
            </StackItem>
        </Stack>

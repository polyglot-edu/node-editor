...
type ReactFlowUMLModelingNodeProps = ReactFlowNodeProps & UMLModelingNode;

const ReactFlowUMLModelingNode = ({ id }: ReactFlowUMLModelingNodeProps) => {
...
export default ReactFlowUMLModelingNode;

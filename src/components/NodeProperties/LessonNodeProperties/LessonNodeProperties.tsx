import { DocumentCard, DocumentCardDetails, DocumentCardImage, DocumentCardTitle, ImageFit, Label, PrimaryButton, Separator, Stack, StackItem, Text } from "@fluentui/react";
                ...
                <Card className="flex flex-col">
                        ...
                        selectedNode.data.file
                            ? <DocumentCard className="self-center w-2/3">
                                <DocumentCardImage
                                    ...
                                    iconProps={{
                                        iconName: "PDF",
                                        styles: { root: { fontSize: '90px', width: '90px', height: '90px' } },
                                    }}
                                />
                                <DocumentCardDetails>
                                    <DocumentCardTitle title={selectedNode.data.file.name} shouldTruncate />
                                </DocumentCardDetails>
                            </DocumentCard>
                    ...
                    <PrimaryButton className="mt-4 self-center w-1/2 p-0" >
                        <label className="w-full h-full flex flex-col justify-center" >
                            <span className="self-center" > {selectedNode.data.file ? "Change file" : "Upload file"}</span>
                            <input className="sr-only w-full h-full" type="file" accept=".pdf" onChange={onFilePick} />
                        </label>
                    </PrimaryButton>
                </Card>
            </StackItem>
